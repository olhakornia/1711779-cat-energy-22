(function () {
  ...
  var slider = document.querySelector(".example__compare");
  var scale = slider.querySelector(".slider__scale");
  var grip = scale.querySelector(".slider__grip");
  var before = slider.querySelector(".compare__image--before");
  var after = slider.querySelector(".compare__image--after");
